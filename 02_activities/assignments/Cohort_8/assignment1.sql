...
SELECT vendor_id,
  COUNT(vendor_id) AS rental_count
...
DROP TABLE IF EXISTS temp.customer_spending;
CREATE TABLE temp.customer_spending AS
SELECT customer_id,
...
-- Thomas asked to skip as this portion was not covered in classes this week 
